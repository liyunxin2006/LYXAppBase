...
#define LYXSuccess(message) [TWMessageBarManager.sharedInstance showMessageWithTitle:LYX_ALERT_TITLE description:message type:TWMessageBarMessageTypeSuccess statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
#define LYXError(message)   [TWMessageBarManager.sharedInstance showMessageWithTitle:LYX_ALERT_TITLE description:message type:TWMessageBarMessageTypeError statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
#define LYXInfo(message)    [TWMessageBarManager.sharedInstance showMessageWithTitle:LYX_ALERT_TITLE description:message type:TWMessageBarMessageTypeInfo statusBarStyle:UIStatusBarStyleLightContent callback:NULL]

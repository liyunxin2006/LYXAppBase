...
@interface LYXNewsTableViewCell () <DTAttributedTextContentViewDelegate>

@property (nonatomic, strong) LYXNewsItemViewModel *viewModel;
@property (nonatomic, weak) IBOutlet UIButton *avatarButton;
@property (nonatomic, weak) IBOutlet DTAttributedLabel *detailView;

@end

@implementation LYXNewsTableViewCell
...
- (void)bindViewModel:(LYXNewsItemViewModel *)viewModel {
    self.viewModel = viewModel;
    
    [self.avatarButton sd_setImageWithURL:viewModel.event.actorAvatarURL
                                 forState:UIControlStateNormal
                         placeholderImage:[LYXNewsTableViewCell placeholderImage]];
...
- (IBAction)didClickAvatarButton:(id)sender {
    [self.viewModel.didClickLinkCommand execute:[NSURL lyx_userLinkWithLogin:self.viewModel.event.actorLogin]];
}
